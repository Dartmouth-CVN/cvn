...
public class SearchTabController {
    ...
    private void initialize() {
        ...
        firstNameColumn.setCellValueFactory(
                cellData -> cellData.getValue().firstNameProperty());//firstNameProperty will be in Profile model
        lastNameColumn.setCellValueFactory(
                cellData -> cellData.getValue().lastNameProperty()); //lastNamePropert will be in Profile model
